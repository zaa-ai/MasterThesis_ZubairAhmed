...
source -echo $env(PROJECT_HOME)/scripts/layout/tcl/fm/fm_settings.tcl
...
set_constant -type cell r:/WORK/${DESIGN_NAME}/i_logic_top/i_test/i_test_control/i_scan_registers_i_scan_registers_SCAN_SCAN_reg 0
set_constant -type cell r:/WORK/${DESIGN_NAME}/i_logic_top/i_test/i_test_control/i_scan_registers_i_scan_registers_SCAN_COMPRESSION_reg 0
set_constant -type cell r:/WORK/${DESIGN_NAME}/i_logic_top/i_test/i_test_control/i_scan_registers_i_scan_registers_SCAN_VDD_DIS_reg 0
...
source -echo $env(PROJECT_HOME)/scripts/layout/tcl/fm/fm_match.tcl
