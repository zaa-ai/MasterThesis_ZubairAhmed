...
set NETLIST_FILES               "digtop.output.v"
...
set dmsa_corner_library_files(max) "[exec getPrjCfg.rb -r $TECH -p tech/lib/max\[@type='gates'\]] [join [exec getPrjCfg.rb -r $TECH -p tech/lib/max\[@type='macro'\]]]"
set dmsa_corner_library_files(min) "[exec getPrjCfg.rb -r $TECH -p tech/lib/min\[@type='gates'\]] [join [exec getPrjCfg.rb -r $TECH -p tech/lib/min\[@type='macro'\]]]"
...
# ELMOS: added corner constraints
#set dmsa_mode_constraint_files(func_max) "digtop.constraints.func_max.tcl"
#set dmsa_mode_constraint_files(func_min) "digtop.constraints.func_min.tcl"
#set dmsa_mode_constraint_files(scan_max) "digtop.constraints.scan_max.tcl"
#set dmsa_mode_constraint_files(scan_min) "digtop.constraints.scan_min.tcl"
set dmsa_mode_constraint_files(bridge_scan_max) "digtop.constraints.bridge_scan_max.tcl"
set dmsa_mode_constraint_files(bridge_scan_min) "digtop.constraints.scan_min.tcl"
...
set PARASITIC_FILES(max)	 "digtop.starrc.spef.WCCOM.gz" 
set PARASITIC_FILES(min)	 "digtop.starrc.spef.LTCOM.gz" 
set PARASITIC_PATHS(max)	 "digtop" 
set PARASITIC_PATHS(min)	 "digtop" 
...
set eco_drc_buf_list "BUFFD1BWP7T BUFFD2BWP7T"
