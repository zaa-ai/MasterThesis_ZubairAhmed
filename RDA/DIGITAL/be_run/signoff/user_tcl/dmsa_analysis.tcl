...
#=======================================================================
report_global_timing -pba_mode exhaustive > $REPORTS_DIR/${DESIGN_NAME}_dmsa_report_global_timing.report
...
report_constraints -pba_mode exhaustive -all_violators -verbose > $REPORTS_DIR/${DESIGN_NAME}_dmsa_report_constraints.report
remote_execute {
report_constraints -pba_mode exhaustive -all_violators -verbose > $REPORTS_DIR/${DESIGN_NAME}_report_constraints.report
