...
source user_tcl/pt_dmsa_setup_bridge.tcl
...
file delete -force ./work_bridge
set multi_scenario_working_directory ./work_bridge
set multi_scenario_merged_error_log ./work_bridge/error_log.txt
...
foreach corner $dmsa_corners {
 foreach mode $dmsa_modes {
  create_scenario \
   ...
   -specific_data "$sdir/user_tcl/common_setup.tcl $sdir/user_tcl/pt_dmsa_setup_bridge.tcl $sdir/user_tcl/dmsa_mc_bridge.tcl"
 }
}
...
source $sdir/user_tcl/dmsa_analysis_bridge.tcl
