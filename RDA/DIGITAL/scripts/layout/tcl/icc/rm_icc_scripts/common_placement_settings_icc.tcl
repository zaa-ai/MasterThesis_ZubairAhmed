...
## This variable will add a soft constraint during placement to reduce the pin density to below the specified value.
# You will need to determine the appropriate value for MAX_PINS_PER_SQUARE_MICRON for your design
#
