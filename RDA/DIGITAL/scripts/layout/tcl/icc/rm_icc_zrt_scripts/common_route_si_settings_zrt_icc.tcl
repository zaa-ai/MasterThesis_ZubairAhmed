...
# ELMOS: enabled static noise analysis, to better correlate ICC and PT
set_si_options -delta_delay true \
               -route_xtalk_prevention true \
               -route_xtalk_prevention_threshold 0.25 \
 	 -analysis_effort medium \
...
#Elmos: Antenna prevention
set_route_zrt_detail_options -default_port_external_gate_size 0.0

# ELMOS: fixing VIA4 issue with some technologies
set_route_zrt_common_options -filter_redundant_via_mapping false
