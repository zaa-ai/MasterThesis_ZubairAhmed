...
# Before doing some route_zrt_global the power/ground network should be completed
# moved this snipped up from the Template Based Power Network Synthesis (T-PNS) section
#  Please specify a customized script through $CUSTOM_ICC_DP_PNS_SCRIPT

if {[file exists [which $CUSTOM_ICC_DP_PNS_SCRIPT]]} {
    echo "Info: Sourcing [which $CUSTOM_ICC_DP_PNS_SCRIPT]"
    source $CUSTOM_ICC_DP_PNS_SCRIPT
    echo "Info: Finished script [which $CUSTOM_ICC_DP_PNS_SCRIPT]"
...
#
# Moved upwards before route_zrt_global
##  Please specify a customized script through $CUSTOM_ICC_DP_PNS_SCRIPT
#if {[file exists [which $CUSTOM_ICC_DP_PNS_SCRIPT]]} {
#  source $CUSTOM_ICC_DP_PNS_SCRIPT
#}
