...
set DCRM_DFT_OCC_CONFIG_INPUT_FILE                      ${DESIGN_NAME}.dft_occ_config.tcl
...
#ELMOS: added filenames for IDDQ
#
...
set DCRM_DFT_DRC_FINAL_PLL_BYPASS_REPORT                ${DESIGN_NAME}.mapped.dft_drc_inserted.pll_bypass.rpt
...
set DCRM_DFT_DRC_FINAL_SCAN_COMPR_PLL_BYPASS_REPORT     ${DESIGN_NAME}.mapped.dft_drc_inserted.scan_compression.pll_bypass.rpt
