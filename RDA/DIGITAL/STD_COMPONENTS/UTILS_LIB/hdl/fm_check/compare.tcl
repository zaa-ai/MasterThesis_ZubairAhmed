set DESIGN_NAME                   "utils_sram_bist_march_22n"  ;#  The name of the top-level design
...
read_sverilog -r -libname WORK { /nfs/wrk.jvoi/projekte/52143/p52143/DIGITAL/STD_COMPONENTS/RAM_ROM_LIB/hdl/bist_pkg.sv }
read_sverilog -r -libname WORK { /nfs/wrk.jvoi/projekte/52143/p52143/DIGITAL/STD_COMPONENTS/RAM_ROM_LIB/hdl/bist_if.sv }
read_sverilog -r -libname WORK { /nfs/wrk.jvoi/projekte/52143/p52143/DIGITAL/STD_COMPONENTS/UTILS_LIB/hdl/utils_sync_ff_re.v }
read_sverilog -r -libname WORK { /nfs/wrk.jvoi/projekte/52143/p52143/DIGITAL/STD_COMPONENTS/UTILS_LIB/hdl/utils_ff_re.v }
read_sverilog -r -libname WORK { /nfs/wrk.jvoi/projekte/52143/p52143/DIGITAL/STD_COMPONENTS/UTILS_LIB/hdl/utils_sync_level.v }
read_sverilog -r -libname WORK { /nfs/wrk.jvoi/projekte/52143/p52143/DIGITAL/STD_COMPONENTS/UTILS_LIB/hdl/fm_check/utils_sram_bist_march_22n.r769.sv }
set_top r:/WORK/${DESIGN_NAME}

read_sverilog -i -libname WORK { /nfs/wrk.jvoi/projekte/52143/p52143/DIGITAL/STD_COMPONENTS/RAM_ROM_LIB/hdl/bist_pkg.sv }
read_sverilog -i -libname WORK { /nfs/wrk.jvoi/projekte/52143/p52143/DIGITAL/STD_COMPONENTS/RAM_ROM_LIB/hdl/bist_if.sv }
read_sverilog -i -libname WORK { /nfs/wrk.jvoi/projekte/52143/p52143/DIGITAL/STD_COMPONENTS/UTILS_LIB/hdl/utils_sync_ff_re.v }
read_sverilog -i -libname WORK { /nfs/wrk.jvoi/projekte/52143/p52143/DIGITAL/STD_COMPONENTS/UTILS_LIB/hdl/utils_ff_re.v }
read_sverilog -i -libname WORK { /nfs/wrk.jvoi/projekte/52143/p52143/DIGITAL/STD_COMPONENTS/UTILS_LIB/hdl/utils_sync_level.v }
read_sverilog -i -libname WORK { /nfs/wrk.jvoi/projekte/52143/p52143/DIGITAL/STD_COMPONENTS/UTILS_LIB/hdl/utils_sram_bist_march_22n.sv }
