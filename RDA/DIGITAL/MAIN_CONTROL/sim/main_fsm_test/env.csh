...
setenv TESTCASE  main_fsm_test
setenv UVM_TESTCASE top_test
setenv TC_DESCRIPTION "Unit test of main FSM module"
...
setenv ANALYZE_OPTIONS "-sverilog +define+UVM_NO_DEPRECATED -timescale=1ps/1ps +define+SVUNIT_VERSION='3_26'"
setenv ANALYZE_OBJECTS	"tech/TSMC_180_BCD ECC OTP_MEM edf_registers MAIN_CONTROL otp MAIN_CONTROL/tb/tb_main_fsm tb_eugene model"
