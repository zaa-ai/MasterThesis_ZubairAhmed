...
report_path = os.path.join(os.getenv("BAMBOO_BUILD_WORKING_DIRECTORY", "."), "DIGITAL", "rda_report.json")
out_path = os.path.join(os.getenv("BAMBOO_BUILD_WORKING_DIRECTORY", "."), "DIGITAL", "report_summary.html")
...
with open(out_path, "w", encoding="utf-8") as html:
    ...
    html.write("<h2>ð?§ª RDA Binning Summary</h2>")
    ...
    for i, bucket in enumerate(buckets, 1):
        ...
        html.write(f"<div class='bucket'><h3>ð?"¦ Bucket {i}</h3>")
